...
Refreshed 2026-06-29. The flight-search MCP was UP this session and returned full
...
ICN 07-04/07-15/08-01/09-01/11-25 came inline today and are overlaid with fresh
values (the aggregator otherwise backfills them from stale prior-session files).
NRT 09-01/11-25/12-20/01-15 and ICN 12-20/01-15 saved to files this session and
are NOT listed here (the overlay would clobber fresh file data). 2026-06-15 is in
the past (today is 2026-06-29) and is omitted entirely.
"""
import json
...
# Manual entries -- top 3 cheapest non-ghost fares per (corridor, date), observed 2026-06-29.
MANUAL = [
    ...
    ("HND-HNL", "2026-07-15", [
        {"airline": "Alaska Airlines", "price": 345, "is_nonstop": 1, "duration_mins": 475},
        {"airline": "Alaska Airlines", "price": 550, "is_nonstop": 1, "duration_mins": 475},
        {"airline": "Korean Air", "price": 560, "is_nonstop": 0, "duration_mins": 530},
    ]),
    ("HND-HNL", "2026-08-01", [
    ...
    ("HND-HNL", "2026-12-20", [
        {"airline": "Alaska Airlines", "price": 445, "is_nonstop": 1, "duration_mins": 435},
        {"airline": "Alaska Airlines", "price": 445, "is_nonstop": 1, "duration_mins": 435},
        {"airline": "Delta Air Lines", "price": 447, "is_nonstop": 1, "duration_mins": 420},
    ]),
    ("HND-HNL", "2027-01-15", [
        {"airline": "Delta Air Lines", "price": 447, "is_nonstop": 1, "duration_mins": 410},
        {"airline": "Korean Air", "price": 579, "is_nonstop": 0, "duration_mins": 490},
    ...
    ("KIX-HNL", "2026-08-01", [
        ...
        {"airline": "Japan Airlines", "price": 765, "is_nonstop": 1, "duration_mins": 480},
    ]),
    ("KIX-HNL", "2026-09-01", [
    ...
    # ICN-HNL (07-04 / 07-15 / 08-01 / 09-01 / 11-25 came inline; 12-20 / 01-15 are file-based this session)
    ("ICN-HNL", "2026-07-04", [
        {"airline": "Korean Air", "price": 589, "is_nonstop": 0, "duration_mins": 510},
        {"airline": "Korean Air", "price": 605, "is_nonstop": 0, "duration_mins": 510},
        {"airline": "Korean Air", "price": 692, "is_nonstop": 0, "duration_mins": 475},
    ]),
    ("ICN-HNL", "2026-07-15", [
        {"airline": "Perimeter Aviation", "price": 444, "is_nonstop": 1, "duration_mins": 530},
        {"airline": "Korean Air", "price": 543, "is_nonstop": 0, "duration_mins": 510},
        {"airline": "Asiana Airlines", "price": 555, "is_nonstop": 0, "duration_mins": 475},
    ]),
    ("ICN-HNL", "2026-08-01", [
        {"airline": "Korean Air", "price": 679, "is_nonstop": 0, "duration_mins": 510},
        {"airline": "Korean Air", "price": 692, "is_nonstop": 0, "duration_mins": 475},
        {"airline": "Korean Air", "price": 692, "is_nonstop": 0, "duration_mins": 475},
    ]),
    ("ICN-HNL", "2026-09-01", [
    ...
    ("ICN-HNL", "2026-11-25", [
        ...
        {"airline": "Korean Air", "price": 478, "is_nonstop": 0, "duration_mins": 435},
        {"airline": "Korean Air", "price": 482, "is_nonstop": 0, "duration_mins": 455},
    ]),
]
